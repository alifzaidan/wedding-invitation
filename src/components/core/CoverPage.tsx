...
export default function CoverPage() {
    ...
    return (
        <div
            className={`fixed inset-0 h-screen sm:p-8 p-4 bg-cover transition-transform duration-700 overflow-hidden ${
        ...
        >
            <div className="flex flex-col justify-center items-center sm:gap-3 gap-2 p-5 bg-white text-center rounded-full bg-opacity-80 h-full w-full">
                <Image src={'/assets/img/flower-1.png'} alt="Castle" width={1000} height={1000} className="absolute top-0 sm:w-1/2 " />
                <Image
                ...
                <h2 className={`${tangerine.className} md:text-8xl text-6xl font-bold sm:mb-6 mb-3 text-red-900`}>Izza & Risky</h2>
                ...
                <button
                    ...
                    className="flex gap-2 items-center justify-center mt-2 bg-red-900 text-white md:text-base text-sm py-2 px-4 rounded-full transition duration-200 md:hover:bg-red-800"
                >
