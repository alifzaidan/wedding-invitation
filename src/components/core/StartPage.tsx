...
export default function StartPage() {
    return (
        <section className="relative flex flex-col items-center sm:gap-3 gap-2 pt-40 bg-pattern text-center w-full h-screen -z-10">
            ...
            <div className="text-red-900 space-y-6 z-10">
                ...
                <div className="mx-auto border border-red-900 w-8 h-12 rounded-full flex items-end justify-center">
